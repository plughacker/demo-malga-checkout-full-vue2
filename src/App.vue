...
import {
  ...
  PlugCheckoutFullVueData,
} from "./App.types";

export default {
  data(): PlugCheckoutFullVueData {
    return {
  ...
  methods: {
    handlePaymentSuccess(data: PlugCheckoutFullTransactionSuccessEvent): void {
      console.log(data);
    },
    handlePaymentFailed(error: PlugCheckoutFullTransactionErrorEvent): void {
      console.log(error);
    },
  },
};
